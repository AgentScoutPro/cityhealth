...
export default function OnPageTab() {
  const { issues, loading } = useIssues('onpage')
  const passing = usePassing()
  const onPagePassing = passing.filter(p => p.category === 'onpage')

  return (
    <div className="space-y-6 max-w-4xl">
      <h1 className="text-xl font-black">On-Page SEO</h1>
